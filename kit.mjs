 ...
 *
 * Drawings never talk to roughjs directly — they compose the helpers below. That
 * is what keeps a drawing made six months from now in the same hand as the first
 * one: stroke weights, fills, roughness and the palette live here and nowhere
 * else.
 *
 * Do not edit this file. Changing a weight or a colour here changes every
 * drawing ever made from it. See CLAUDE.md for how to draw one.
 */
